...
time.sleep(1)
typing_print ("This quiz is about finding out where your next vacation should be headed. Now that summer is coming up. 😊The quiz contains about 15 questions to find your perfect holiday destination. Have fun!")
time.sleep(1)
time.sleep(2)
...
#Question 1
print ("So, first question,", player_name)
time.sleep(1)
time.sleep(2)
time.sleep(3)
landscape_type = str(input( "Do you prefer the mountains or the sea? 🏔️ vs. 🌊: "))
if landscape_type == "mountains":
    ...
    points_carribean += 1
    points_la += 1
    typing_print("I knew, you seemed like a water person to me")
else:
    typing_print("Your answer is invalid. Please chose between 'mountains' or 'sea' 😊")
...
time.sleep(2)
time.sleep(3)
activity_type = str(input("Do you like more active or relaxing holidays?: "))
if activity_type == "active":
    points_norway += 1
    points_la += 1
    typing_print("I see, you are more of the action kind.")
elif activity_type == "relaxing":
    points_carribean += 1
    typing_print("Good choice, sometimes all you need to do is recharge your energy.")
else:
    typing_print("Your answer is invalid. Please chose between 'active' or 'relaxing' 😊")
...
time.sleep(2)
time.sleep(3)
daytime_type = str(input( "Are daytime activities important to you or do you rather value a good nightlife? (Please answer with either 'daytime' or 'nightlife):"))
if daytime_type == "daytime":
    points_norway += 1
    points_carribean += 1
    print ("Who doesn't like to have a good sleep in on vacation. Right,", player_name, "?")
elif daytime_type == "nightlife":
    points_la += 1
    typing_print("🎶A little party never hurt nobody.🎶")
else:
    typing_print("Your answer is invalid. Please chose between 'daytime' or 'nightlife' 😊")
...
if duration_type < 2 or duration_type > 21:
