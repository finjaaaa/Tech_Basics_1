#This is a better version of the assignment of week 2. This quiz includes 10 questions to find the players perfect summer holiday destination.
#The player can choose between 2 or 3 different options per answer. Each answer adds a point to one of the three destinations. The destination with the most point will be the most fitting suggestion for the player.
import time
import sys
...
#creating a general function for the questions
def ask_question(prompt, valid_answers):
    while True:
        ...
        if answer in valid_answers:
            ...
            print("Please enter a valid answer using one of the following options: " + ", ".join(valid_answers))
...
time.sleep(1)
time.sleep(2)
landscape_type = ask_question("Do you prefer mountains or sea? 🏔️ vs. 🌊: ", ["mountains", "sea"])
#using the different answers from the original code
...
time.sleep(1)
time.sleep(2)
activity_type = ask_question( "Do you prefer active or relaxing holidays? (active/relaxing):", ["active", "relaxing"])
...
time.sleep(2)
time.sleep(3)
daytime = ask_question("Prefer daytime activities or nightlife? (daytime/nightlife): ", ["daytime", "nightlife"])
if daytime == "daytime":
    points_norway += 1
...
time.sleep(2)
time.sleep(3)
temperature_type = ask_question("Do you want to spend your trip in a rather hot, mild or cold climate?:", ["hot", "mild", "cold"])
if temperature_type == "hot":
    points_carribean += 1
    print ("You enjoy the heat, i see")
elif temperature_type == "mild":
    points_la += 1
    print("Not too warm, not too cold - always a great choice.")
...
time.sleep(2)
time.sleep(3)
hobby_type = ask_question("If you had to choose between 'nature', 'culture' or 'shopping'... What would your go-to-activity be for the trip?: ", ["nature", "culture", "shopping"])
...
time.sleep(2)
time.sleep(3)
lodging_type = ask_question("Would you rather stay in a holiday home, a resort or in a hotel when on vacation?:", ["holiday home", "resort or in hotel"])
...
#Question 7
typing_print ("Okay, next question.")
time.sleep(1)
time.sleep(2)
time.sleep(3)
group_type = ask_question("Do you plan on travelling alone, with friends or with family?:", ["alone", "family", "friends"])
...
#Question 8
print("I've got only two questions left for you")
time.sleep(1)
time.sleep(2)
time.sleep(3)
while True:
...
time.sleep(2)
time.sleep(3)
transport_type=ask_question("What's your preferred type of transport on vacation? Do you prefer travelling by train, car or boat?:", ["train", "car", "boat"])
...
time.sleep(1)
time.sleep(2)
print("Hurray, you've made it through the quiz...😊 It's time to find out about your perfect holiday destination for this summer,")
time.sleep(1)
time.sleep(2)
